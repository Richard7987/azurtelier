---
title: Sistema de Cultivo Automatizado de Hongos
date: '2024-05-22'
tags: ['proyecto', 'hongos']
draft: false
summary: sistema modular e inteligente para el cultivo automatizado de hongos comestibles y medicinales.
---
...
> Para una representación visual del proceso completo, consultar [[Proyectos/Oclto/Diagrama de flujo|Diagrama de flujo]]
...
### Fase 1: Prototipo
- [X] Construcción de un módulo de prueba
- [X] Implementación del sistema básico de sensores
- [X] Desarrollo de la interfaz de control preliminar

### Fase 2: Desarrollo de IA
- [X] Recolección de datos de crecimiento
- [X] Entrenamiento de modelos de visión artificial
- [X] Pruebas de predicción de cosecha

### Fase 3: Escalamiento
- [X] Optimización del diseño modular
- [X] Mejora de la eficiencia energética
- [X] Implementación de sistema completo multi-módulo
...
Para más detalles sobre la metodología de cultivo, consultar [[blog/proyectos/invernadero/metodologia|Metodologiia]].